...
// ── Computed alur berdasarkan role + nominal ───────────────────────
...
<template>
    <Head title="Tambah Nota Belanja" />
    ...
    <div class="space-y-6 p-4 sm:p-6 lg:p-8">
        ...
        <div class="flex items-start gap-3">
            ...
            <PageHeader
                title="Tambah Nota Belanja Langsung"
                eyebrow="Reimburse"
                subtitle="Catat pembelanjaan langsung tanpa alur pengadaan formal"
            />
        </div>
        ...
        <Section title="Detail Nota" eyebrow="Informasi">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <!-- Banner alur — muncul setelah nominal diisi -->
                <div v-if="form.nominal > 0" class="sm:col-span-2">

                    <!-- Keuangan: langsung dibayar -->
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea
                        v-model="form.uraian"
                        rows="3"
                        placeholder="Contoh: Pembelian materai untuk kontrak pengadaan ATK bulan Mei 2026"
                ...
                <div class="sm:col-span-2">
                    ...
                    >
                        <span class="flex-1 text-muted-foreground">
                            {{ form.file_nota ? form.file_nota.name : 'Pilih file foto nota atau scan kwitansi...' }}
                        </span>
        ...
        <div class="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
            ...
            <!-- Tombol Simpan Draft — hanya tampil jika nominal besar (wajib PPTK) -->
            <PrimaryButton
            ...
            <!-- Tombol utama — labelnya berubah sesuai alur -->
            <PrimaryButton
                type="button"
                variant="primary"
                size="lg"
