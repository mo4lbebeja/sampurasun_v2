...
@php
     ...
     * PIHAK KESATU = pejabat_penandatangan_id
     * PIHAK KEDUA  = kpa_penandatangan_id
     */
    ...
    $baprhp = $dokumenMap->get('baprhp') ?? $dokumen ?? null;

    $tanggalBaprhpRaw = $baprhp?->tanggal
    ...
    $tanggalCarbon = \Carbon\Carbon::parse($tanggalBaprhpRaw);
...
<div class="paragraph">
    Bertindak untuk dan atas nama {{ $namaUnitKerja }} selaku Pejabat Pembuat Komitmen,
    yang selanjutnya disebut <span class="font-bold">PIHAK KESATU</span> sebagai yang
    menyerahkan hasil Pekerjaan Pengadaan {{ $namaRekening }}.
</div>
...
<div class="paragraph">
    Bertindak untuk dan atas nama {{ $namaUnitKerja }}, yang selanjutnya disebut
    <span class="font-bold">PIHAK KEDUA</span> sebagai yang menerima hasil Pekerjaan
    Pengadaan {{ $namaRekening }} kegiatan {{ $namaKegiatan }}.
</div>

<div class="paragraph">
    PIHAK KESATU telah menyerahkan kepada PIHAK KEDUA dan PIHAK KEDUA telah memeriksa
    dan menerima hasil pekerjaan dalam kondisi lengkap, dengan uraian sebagaimana terlampir
    sesuai dengan Surat Pesanan/SP Nomor: {{ $pengadaan->no_kontrak ?? '-' }} tanggal
    {{ $tanggalKontrak }}.
</div>

<div class="paragraph">
    Demikian Berita Acara Penerimaan Hasil Pekerjaan Pengadaan {{ $namaRekening }} dalam
